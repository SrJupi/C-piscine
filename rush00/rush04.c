...
/*   Updated: 2022/04/03 20:24:57 by lsulzbac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	isvalidnumber4(int columna, int fila)
{
	if (columna <= 0 || fila <= 0)
	{
...
void	write_line4(char characters[3], int numcolumnas)
{
	int	columna_actual;
