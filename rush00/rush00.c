...
/*   Updated: 2022/04/03 20:22:34 by lsulzbac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	isvalidnumber0(int columna, int fila)
{
	if (columna <= 0 || fila <= 0)
	{
...
void	write_line0(char characters[3], int numcolumnas)
{
	int	columna_actual;
